...
class trainModel():
    def __init__(self, data_dir):
        ...
        # train a neural network now
        self.clf = MLPClassifier(hidden_layer_sizes=(1000, ))
...
def train():
    ...
    joblib.dump(trained_model, 'mlp_model.pkl')

def test(soundclip):
#    trained_model = train()
    clippath = os.path.abspath(soundclip)
    trained_model = joblib.load('mlp_model.pkl') 
