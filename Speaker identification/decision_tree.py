# -*- coding: utf-8 -*-
"""
Created on Wed May 23 13:16:47 2018
...
class trainModel():
    def __init__(self, data_dir):
        ...
        self.clf = tree.DecisionTreeClassifier(criterion='entropy', splitter='best', presort=True)
        self.clf = self.clf.fit(mfcc_list, speaker_ids)
    ...
    def predict(self, soundclip):
        ...
        speaker_id = self.clf.predict([fvec])[0]
...
def train():
    ...
    joblib.dump(trained_model, 'dt_model.pkl')

def test(soundclip):
#    trained_model = train()
    clippath = os.path.abspath(soundclip)
    trained_model = joblib.load('dt_model.pkl') 
